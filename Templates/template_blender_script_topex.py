...
#           bpy.context.scene.collection.children.link(coll)
    ...
    obj_name = "Topex-Posidon"  #"Cylinder"
...
#    bpy.ops.outliner.show_one_level(open=False)
    ...
    bpy.data.materials["GPMcore-SolarFaces1"].node_tree.nodes["Principled BSDF"].inputs[6].default_value = 1
    
    bpy.data.materials["GPMcore-SolarFaces2"].node_tree.nodes["Principled BSDF"].inputs[9].default_value = sp_value
    bpy.data.materials["GPMcore-SolarFaces2"].node_tree.nodes["Principled BSDF"].inputs[6].default_value = 1
    
    bpy.data.materials["GPMcore-SolarFaces3"].node_tree.nodes["Principled BSDF"].inputs[9].default_value = sp_value
    bpy.data.materials["GPMcore-SolarFaces3"].node_tree.nodes["Principled BSDF"].inputs[6].default_value = 1
    
    bpy.data.materials["GPMcore-SolarFaces4"].node_tree.nodes["Principled BSDF"].inputs[9].default_value = sp_value
    bpy.data.materials["GPMcore-SolarFaces4"].node_tree.nodes["Principled BSDF"].inputs[6].default_value = 1
    
    bpy.data.materials["GPMcore-SolarFaces5"].node_tree.nodes["Principled BSDF"].inputs[9].default_value = sp_value
    bpy.data.materials["GPMcore-SolarFaces5"].node_tree.nodes["Principled BSDF"].inputs[6].default_value = 1
    
    bpy.data.materials["GPMcore-SolarFaces6"].node_tree.nodes["Principled BSDF"].inputs[9].default_value = sp_value
    bpy.data.materials["GPMcore-SolarFaces6"].node_tree.nodes["Principled BSDF"].inputs[6].default_value = 1
    
    bpy.data.materials["GPMcore-SolarFaces7"].node_tree.nodes["Principled BSDF"].inputs[9].default_value = sp_value
    bpy.data.materials["GPMcore-SolarFaces7"].node_tree.nodes["Principled BSDF"].inputs[6].default_value = 1
    
    bpy.data.materials["GPMcore-SolarFaces8"].node_tree.nodes["Principled BSDF"].inputs[9].default_value = sp_value
    bpy.data.materials["GPMcore-SolarFaces8"].node_tree.nodes["Principled BSDF"].inputs[6].default_value = 1
...
#    sat_obj = bpy.context.active_object
    sat_obj = bpy.data.objects["Topex-Posidon-composite"] #["Cylinder"]
    sat_obj.name = "Satellite"
...
#        sat_obj.location = geocentric.frame_xyz(itrs).km / my_scale
    ...
    incl = line2.split()[2]
    incl = float(incl)
    sat_obj.rotation_euler[2] = radians(90-incl)
...
#    Initial Satellite angle in rotation (Phase)
    sat_obj.rotation_euler[1] = radians( {{p_phase}} )


#    Precession Angle and precession Period
#    sat_obj.delta_rotation_euler[1] = radians(0) # Y
    empty_prec_obj.rotation_euler[0] = radians({{pr_angle}})
    prec_period = {{p_prec}}

#    Initial Satellite precession angle in rotation (Phase)
    empty_prec_obj.rotation_euler[2] = radians({{ p_pr_phase }})
...
#        bpy.ops.transform.rotate(value=radians(360/sat_period), orient_axis="X", orient_type='LOCAL')
        ...
        sat_obj.rotation_euler[2] += radians(360/sat_period) #sat_axis_rot 
