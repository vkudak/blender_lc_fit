...
#    constraint.target=sat_obj
    ...
    p_phase, pr_phase, pr_angle, cross_width, cross_lenght, sp_w, sp_l = {{var_list[0]}}, {{var_list[1]}}, {{var_list[2]}}, {{var_list[3]}}, {{var_list[4]}}, {{var_list[5]}}, {{var_list[6]}}
...
#----------------------PANELS --------------------
    sat_sp1.dimensions = [sp_w/my_scale, sp_l/my_scale, 0.182/my_scale]
    sat_sp2.dimensions = [sp_w/my_scale, sp_l/my_scale, 0.182/my_scale]
#    -------- SP1 -------------
    sat_sp1.select_set(True)
    bpy.ops.object.transform_apply(location=False, rotation=False, scale=True)
    
    sat_sp1.location[0] = -1* (0.00175 + sat_sp1.dimensions[0] / 2.0)  
    # sat_sp1.select_set(True)
...
#    ------- SP2 ------
    ...
    sat_sp2.location[0] = 1* (0.00175 + sat_sp2.dimensions[0] / 2.0)  
    # sat_sp2.select_set(True)
    # bpy.ops.object.transform_apply(location=True, rotation=False, scale=False)
